<div align="center" style="padding: 20px;">
   ...
   <table align="center">
      <tr>
         ...
         <td><a href="https://github.com/ChronoMonochrome/django_project">django_project</a> - Celery、Redis、PostgreSQL、Bjoern、Nginxを使用して、Excelファイルのアップロードと安全なAPI経由のデータ管理を行うDjangoウェブアプリケーション。</td>
      </tr>
      <tr>
